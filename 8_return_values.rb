...
def mean(list_of_numbers)
  ...
  num_list = list_of_numbers.length
...
def variance(list_of_numbers)
  ...
  list_of_numbers.each do |number|
    diff = number-mean_list
    temp_array.push((diff)**2)
  end
...
def standard_deviation(list_of_numbers)
  return variance(list_of_numbers)**(0.50)
end

test_array = [2.0,3.0,4.0]
puts standard_deviation(test_array).to_s
